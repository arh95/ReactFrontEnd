...
<br/><br/>
Otherwise, this app can be run locally by compiling and running the front end using **npm run build** and **npm start**, and the backend GOLANG server(https://github.com/arh95/GolangChessServer/tree/master) can be compiled with **go build** and **go run .** in the server's root directory. Once the app is running locally, you can access it using different tabs in the same browser, but I would recommend using separate sessions/browsers or using an incognito mode for one or more of the users, to avoid potential browser caching issues.
<br/><br/>
