...
Unfortuantely, I am still waiting on my domain to be created so I can install SSL, so the app can currently ONLY be accessed using the http protocol.<br/> **I reccomend accessing the site through Firefox, with https-only mode disabled (https://support.mozilla.org/en-US/kb/https-only-prefs)** 
<br/><br/>
